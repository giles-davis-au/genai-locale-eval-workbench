...
They're not hand-written: upload `docs/judge-run-<version>.md` to the external judge, save its single combined response, then run `python3 scripts/split_judge_response.py <version> <path-to-response>` to explode it into the individual files here.
